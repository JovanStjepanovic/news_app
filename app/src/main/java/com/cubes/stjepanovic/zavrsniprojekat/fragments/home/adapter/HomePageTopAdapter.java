...
public class HomePageTopAdapter extends RecyclerView.Adapter<HomePageTopAdapter.HomepageTopHolder> {
    ...
    public HomePageTopAdapter(ArrayList<News> news,RvTopClick listener) {
        this.list = news;
       ...
       if (news.title ==null || news.category.name == null || news.created_at ==null  || news.image == null){
             ...
             holder.binding.textviewTime.setText(news.created_at);
                ...
                if (news.category.subcategory != null){
                   ...
                   holder.binding.textViewCategory.setTextColor(Color.parseColor(news.category.subcategory.color));
                }
                 else {
